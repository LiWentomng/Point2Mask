...
from .voc_instance import VOCInstanceDataset
...
__all__ = ["VOCPanopticDataset"]


INSTANCE_OFFSET = 1000 


class VOCPanoptic(COCO):
    def __init__(self, annotation_file=None):
        super(VOCPanoptic, self).__init__(annotation_file)
...
class VOCPanopticDataset(VOCInstanceDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        """
        self.coco = VOCPanoptic(ann_file)
